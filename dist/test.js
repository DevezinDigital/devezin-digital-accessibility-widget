...
async function getA11yViolations(ui, options) {
    const { container } = react.render(ui);
...
exports.DEFAULT_WCAG_TAGS = DEFAULT_WCAG_TAGS;
exports.expectNoA11yViolations = expectNoA11yViolations;
exports.getA11yViolations = getA11yViolations;
exports.installMatchMediaMock = installMatchMediaMock;
